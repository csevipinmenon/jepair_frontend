      ...
      <div className="w-full">
        <div className="w-full">
          ...
          <div className=" mt-10 text-center">
            <h3 className="font-extrabold text-3xl dark:text-blue-300  text-[#2d2e82] block">
              What is <span className="text-[#ff7f00]">Jepair</span>{" "}
              <span className="text-[#2d2e82] dark:text-blue-300 "> Bazaar?</span>
            </h3>
            <div className="mt-7">
              <p className="text-center font-semibold  lg:ml-52 lg:mr-52 ml-10 mr-10 leading-[2.5] dark:text-white text-[#2d2e82]">
          ...
          <div className="mt-10 text-center border dark:border-gray-800 border-t-2">
            <h3 className="font-extrabold text-3xl dark:text-blue-300 text-[#2d2e82] block  mt-7">
            ...
            <p className="mt-7 font-semibold lg:ml-52 lg:mr-52 ml-10 mr-10 leading-[2.5] dark:text-white text-[#2d2e82] mb-6">
          ...
          <div className="mt-10 text-center">
            ...
            <div className="mt-10 flex flex-col items-center gap-8 sm:flex-row sm:justify-between">
              <div className="flex flex-col items-center">
                <img
                  src="vipin.jpg"
                  alt="Vipin Kumar"
                  className="w-60 h-auto rounded-xl shadow-lg hover:translate-y-1.5 transition-transform duration-200"
                />
              ...
              <div className="flex flex-col items-center">
                <img
                  src="saurabh.jpg"
                  alt="Saurabh Paswan"
                  className="w-72 h-auto rounded-xl shadow-lg hover:translate-y-1.5 transition-transform duration-200"
                />
                <h3 className="mt-3 font-bold text-[#ff7f00]">
                  Mr. Saurabh Paswan
                </h3>
              ...
              <div className="flex flex-col items-center">
                <img
                  src="vishal.jpg"
                  alt="Vishal Kumar"
                  className="w-44 h-auto rounded-xl shadow-lg hover:translate-y-1.5 transition-transform duration-200"
                />
                <h3 className="mt-3 font-bold text-[#ff7f00]">
                  Mr. Vishal Kumar
                </h3>
          ...
          <div className="mt-11 text-center border dark:border-gray-800 border-t-2">
            <h3 className="font-extrabold text-3xl dark:text-blue-300 text-[#2d2e82] block mt-7 ">
              Worldwide movement!
            </h3>
            <p className="mt-10 mb-7 font-semibold lg:ml-52 lg:mr-52 ml-10 mr-10  dark:text-white leading-[2.5] text-[#2d2e82]">
              <span className="text-[#ff7f00] dark:text-blue-300 font-bold">Jepair</span>{" "}
              <span className="text-[#2d2e82] dark:text-blue-300 font-bold"> Bazaar</span>,
